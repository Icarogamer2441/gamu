...
**Theme and Gradient Rules:**
- The initial theme must always be dark.
- Only include a light theme option if explicitly requested by the user.
- Always add creative gradients in specific areas to enhance the site's appearance, such as buttons, the site header, and other key elements.
